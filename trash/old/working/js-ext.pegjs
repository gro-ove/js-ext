...
Program
  = special:(SpecialComment Space*)* __ elements:SourceElements? {
      var result = elements !== "" ? elements : [];
      return {
        type:     "Program",
        elements: special.map (function (a){ return a [0] }).concat (result)
      };
    }
...
UserScriptComment
  = content:("//" WhiteSpace "==UserScript==" WhiteSpace* ImportantCommentPart*) {
      function join (array){
        return array.map (function (a){
          return a && a.indexOf && !a.substring ? join (a) : a;
        }).join ('');
      }
      return {
        type:       "UserScript",
...
JsxComment
  = content:("//" WhiteSpace "==Jsx==" WhiteSpace* ImportantCommentPart*) {
      function join (array){
        return array.map (function (a){
          return a && a.indexOf && !a.substring ? join (a) : a;
        }).join ('');
...
ImportantCommentPart
  = LineTerminator "//" (!LineTerminator SourceCharacter)*

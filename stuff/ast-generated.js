...
var Storage = function (){                                                         // storage.jsxi:1
	...
	Storage.prototype.load = function (){
		try {                                                                      // storage.jsxi:28
			this.__Storage_data = JSON.parse (localStorage [this.__Storage_id]);   // storage.jsxi:26
		} catch (e){                                                               // storage.jsxi:28
			this.__Storage_data = {};                                              // ...
		} 
...
Exif = function (){                                                                // exif.jsxi:1
	...
	Exif.prototype.__Exif_processData = function (arraybuffer){
		...
		var formats = [                                                            // exif.jsxi:70
			{ name: 'unsigned byte', size: 1 },                                    // ...
...
Errors = function (){                                                              // errors.jsxi:1
	var Errors = function (){}, 
		descriptionByNumber = {                                                    // errors.jsxi:2
			'400': 'Bad Request',                                                  // ...
			'401': 'Unauthorized',                                                 // ...
	...
	Errors.description = function (error){                                         // errors.jsxi:4
		if ([object Object].test (error))                                          // errors.jsxi:5
			return descriptionByNumber [String (error)] || 'Неизвестная ошибка';   // errors.jsxi:6
		else
...
ImageSearch = function (){                                                         // imageSearch.jsxi:1
	...
	ImageSearch.items = [                                                          // imageSearch.jsxi:2
		{                                                                          // ...
...
AbstractPage = function (){                                                        // abstractPage.jsxi:1
	...
	AbstractPage.prototype.__AbstractPage_failed = function (errorCode){
		...
		this.__page.html (Mustache.abstractPageFailed ({                           // abstractPage.jsxi:80
			caption: data [1],                                                     // ...
			description: data [2],                                                 // abstractPage.jsxi:76
			errorCode: errorCode,                                                  // abstractPage.jsxi:77
			errorDescription: Errors.description (errorCode)
		}));
	};
...
Crossdomain = function (){                                                         // crossdomain.jsxi:1
	...
	Crossdomain.request = function (url, arraybuffer, callback){                   // crossdomain.jsxi:4
		...
		if (callbacks.hasOwnProperty (url)){                                       // crossdomain.jsxi:10
			...
			if (arraybuffer){                                                      // crossdomain.jsxi:15
				...
				$.ajax ({                                                          // crossdomain.jsxi:28
					url: Crossdomain.proxyUrl (url),                               // ...
					success: handler,                                              // crossdomain.jsxi:26
					error: handler.bind (null, null)
				});
		}
	...
	Crossdomain.proxyUrl = function (url){                                         // crossdomain.jsxi:38
		return 'http://www.corsproxy.com/' + url.replace ([object Object], '');    // crossdomain.jsxi:39
	};
	return Crossdomain;
}(), 
		...
		if (params)                                                                // abstractRequest.jsxi:13
			for (var key in params){                                               // abstractRequest.jsxi:16
				...
				if (value !== undefined && value !== null)                         // abstractRequest.jsxi:15
					this.__AbstractRequest_jsonArgs [key] = String (value);        // abstractRequest.jsxi:16
			}
...
Autoupdate = function (){                                                          // autoupdate.jsxi:1
	...
	function initialize (){                                                        // autoupdate.jsxi:8
		if (timeout === false){                                                    // autoupdate.jsxi:9
			...
			Preferences.on ('autoupdate autoupdate-interval', Autoupdate.force);   // autoupdate.jsxi:11
		}
	}
...
ThreadPage = function (){                                                          // threadPage.jsxi:1
	...
	ThreadPage.prototype.build = function (data, error){
		return Mustache.threadPage ({                                              // threadPage.jsxi:16
			section: this.__ThreadPage_section,                                    // ...
...
PostsList = function (){                                                           // postsList.jsxi:1
	...
	PostsList.prototype.__PostsList_opMessage = function (){
		return this.host.find ('.thread > .content blockquote').text ().trim ();   // postsList.jsxi:106
	};
	...
	PostsList.prototype.__PostsList_update = function (){
		...
		function handler (data){                                                   // postsList.jsxi:194
			if (data === null){                                                    // postsList.jsxi:195
				console.warn ('Not implemented at 196 line of postsList.jsxi');    // postsList.jsxi:196
				...
				if (!focus){                                                       // ...
					...
					if (Preferences.get ('autoupdate-desktop-notifications')){     // postsList.jsxi:213
...
SectionPage = function (){                                                         // sectionPage.jsxi:1
	...
	SectionPage.prototype.build = function (data, error){
		return Mustache.sectionPage ({                                             // sectionPage.jsxi:16
			section: this.__SectionPage_section,                                   // ...
...
ThreadsList = function (){                                                         // threadsList.jsxi:1
	...
	ThreadsList.prototype.__ThreadsList_build = function (data, errorCode){
		if (data === null){                                                        // threadsList.jsxi:21
			...
			this.__set (Mustache.threadsList ({                                    // threadsList.jsxi:62
				section: this.__ThreadsList_section,                               // ...
				threads: threads,                                                  // threadsList.jsxi:54
				pageNumber: this.__ThreadsList_pageNumber,                         // threadsList.jsxi:55
				pages: pages && {                                                  // threadsList.jsxi:60
	...
	ThreadsList.prototype.expand = function (button, count){
		...
		this.__ThreadsList_request = new PostsRequest (this.__ThreadsList_section, threadId).send (function (data, error){
			if (data === null){                                                    // threadsList.jsxi:76
				console.warn ('Not implemented at 77 line of threadsList.jsxi');   // threadsList.jsxi:77
			} else {
...
PostsRequest = function (){                                                        // postsRequest.jsxi:1
	...
	PostsRequest.prototype.__preprocess = function (data, timestamp){
		...
		for (var i = 0; i < data.length; i ++){                                    // postsRequest.jsxi:26
			var raw = data [i];                                                    // ...
			post = PonyabaUtils.fix (raw, this.__PostsRequest_section, i + 1);     // postsRequest.jsxi:20
...
SectionsRequest = function (){                                                     // sectionsRequest.jsxi:1
	...
	images = {                                                                     // sectionsRequest.jsxi:6
		test: 'http://ponyach.ru/images/logoboard/test.png',                       // ...
		r34: 'http://ponyach.ru/images/logoboard/r34.png',                         // sectionsRequest.jsxi:4
		d: 'http://ponyach.ru/images/logoboard/d.png'
	};
	...
	SectionsRequest.prototype.__preprocess = function (data){
		...
		for (var pos = 0; pos < data.length; pos ++){                              // sectionsRequest.jsxi:42
			...
			if (entry._target){                                                    // sectionsRequest.jsxi:20
				result [1].push ({                                                 // sectionsRequest.jsxi:27
					name: entry.name,                                              // ...
				...
				result [0].push ({                                                 // sectionsRequest.jsxi:41
					name: entry.name,                                              // ...
					...
					params: {                                                      // sectionsRequest.jsxi:39
						maxImageSize: entry.maximagesize,                          // ...
						maxReplies: entry.maxreplies,                              // sectionsRequest.jsxi:37
						maxMessageLength: entry.messagelength
					}, 
					logo: images [entry.name]
				});
			}
		}
...
Menu = function (){                                                                // menu.jsxi:1
	var Menu = function (menu, from, position, fixed){                             // menu.jsxi:29
		...
		var param = menus [menu].param ? menus [menu].param (from) : null,         // menu.jsxi:44
		...
		this.element = $(html).appendTo (document.body).css ({                     // menu.jsxi:53
	...
	menus = {                                                                      // menu.jsxi:25
		'image-search': {                                                          // ...
			menu: ImageSearch.items,                                               // ...
			param: function (arg){                                                 // menu.jsxi:9
				return arg.closest ('.thread, .post').find ('[data-type=\"image\"]').attr ('href');
			}
		}, 
		'thread-expand': {                                                         // menu.jsxi:16
			menu: [ 5, 15, 30, 50, 100 ].map (function (arg){                      // ...
				return { label: arg + ' постов', action: 'thread-expand:' + arg };
			})
		}, 
		'add-custom-section': {                                                    // menu.jsxi:20
			menu: [                                                                // ...
				{                                                                  // ...
					label: 'Добавить кастомный раздел',                            // ...
		...
		'remove-custom-section': {                                                 // menu.jsxi:24
			menu: [                                                                // ...
				{                                                                  // ...
					label: 'Удалить кастомный раздел',                             // ...
		...
		timeout = setTimeout (function (arg){                                      // menu.jsxi:90
			...
			function mouseleave (){                                                // menu.jsxi:83
				return timeout = setTimeout (function (arg){                       // menu.jsxi:87
					detPopup.removeClass ('visible').timeout (function (arg){      // menu.jsxi:85
						return detPopup.remove ();                                 // ...
					}, 
					300);                                                          // ...
...
Favorites = function (){                                                           // favorites.jsxi:1
	...
	Favorites.add = function (post){                                               // favorites.jsxi:32
		if (!favorites.hasOwnProperty (post)){                                     // favorites.jsxi:33
			...
			favorites [post] = {                                                   // favorites.jsxi:41
				id: data.id,                                                       // ...
				section: data.section,                                             // favorites.jsxi:39
				subject: data.subjectForced
			};
	...
	(function (arg){                                                               // page.jsxi:12
		dispatcher = new CallbackDispatcher (function (arg){                       // page.jsxi:24
			switch (arg){                                                          // page.jsxi:14
				...
				default:
					console.warn ('Not implemented at 22 line of page.jsxi');      // page.jsxi:22
			}
		});
...
Hiddens = function (){                                                             // hiddens.jsxi:1
	...
	Hiddens.hide = function (post){                                                // ...
		...
		hiddens [post] = data.threadMode ? {                                       // hiddens.jsxi:55
			id: data.id,                                                           // ...
...
Statistics = function (){                                                          // statistics.jsxi:1
	...
	Statistics.get = function (){                                                  // statistics.jsxi:38
		return {                                                                   // statistics.jsxi:42
			threadsVisited: data.threadsVisited.length,                            // ...
			threadsCreated: data.threadsCreated.length,                            // statistics.jsxi:41
			messagesSended: data.messagesSended.length
		};
	};
	...
	Window.prototype.switchTab = function (id){
		...
		if (allTabs.length > 0){                                                   // window.jsxi:74
			if (id !== undefined){                                                 // window.jsxi:75
				...
				id = allTabs.eq (0).data ('button').match ([object Object])[0];    // window.jsxi:81
...
PonyabaUtils = function (){                                                        // ponyabaUtils.jsxi:1
	var PonyabaUtils = function (){}, 
		daysOfWeekNames = {                                                        // ponyabaUtils.jsxi:2
			Sun: 'Воскресенье',                                                    // ...
			Mon: 'Понедельник',                                                    // ...
			Tue: 'Вторник',                                                        // ...
			Wed: 'Среда',                                                          // ...
		...
		monthNames = {                                                             // ponyabaUtils.jsxi:3
			Jan: 'Янв',                                                            // ...
			Feb: 'Фев',                                                            // ...
			Mar: 'Мар',                                                            // ...
			Apr: 'Апр',                                                            // ...
		...
		return message.replace (stupidPonyaba, '').replace (linkDetect,            // ponyabaUtils.jsxi:89
			function (linkBegin, href){                                            // ponyabaUtils.jsxi:44
				if (href.match (postLinksDetect)){                                 // ponyabaUtils.jsxi:45
					...
					return Mustache.postImagelinkThumbinal ({                      // ponyabaUtils.jsxi:72
						url: href,                                                 // ...
						proxyUrl: Crossdomain.proxyUrl (href),                     // ponyabaUtils.jsxi:70
						enabled: imageLinkDetectEnabled
...
Embed = function (){                                                               // embed.jsxi:1
	...
	Embed.buildHtml = function (params){                                           // embed.jsxi:72
		...
		switch (params.type){                                                      // embed.jsxi:76
			...
			case 'vimeo':                                                          // embed.jsxi:79
				return Mustache [$.camelCase ('embed-' + params.type)](params);    // embed.jsxi:80
			default:
	...
	Embed.setPlayer = function (type, id, _target){                                // embed.jsxi:106
		var target = $(_target),                                                   // embed.jsxi:111
			...
			parent = target.closest ('[data-id=\"embeds-host\"] [data-value]');    // embed.jsxi:111
	...
	Embed.process = function (parent){                                             // embed.jsxi:121
		...
		function processElement (element){                                         // embed.jsxi:126
			...
			switch (type){                                                         // embed.jsxi:130
				...
				default:
					console.warn ('Not implemented at 185 line of embed.jsxi');    // embed.jsxi:185
			}
...
Form = function (){                                                                // form.jsxi:1
		...
		Preferences.on ('form-fixed-name-enabled form-fixed-name',                 // form.jsxi:46
			function (arg){                                                        // form.jsxi:39
				...
				if (Preferences.get ('form-fixed-name-enabled')){                  // form.jsxi:41
					...
					name.val (Preferences.get ('form-previous-name', ''));         // form.jsxi:45
			});
	...
	buttons = [                                                                    // form.jsxi:13
		{ 'label': 'B', 'tag': 'b', 'title': 'Жирный' },                           // ...
	...
	Form.prototype.__Form_setDisabled = function (reason, param){
		...
		for (var key in this.__Form_disabled){                                     // form.jsxi:69
			...
			if (value){                                                            // form.jsxi:66
				this.__Form_element.findId ('submit').attr ('disabled', true);     // form.jsxi:67
				return;                                                            // form.jsxi:68
			}
		}
	...
	Form.prototype.__Form_setFile = function (newFile){
		...
		var name = this.__Form_file ? this.__Form_file.name : 'Файл не выбран';    // form.jsxi:117
		...
		if (this.__Form_file){                                                     // form.jsxi:76
			...
			(__ = this.__Form_element.findId ('file-form')[0],                     // form.jsxi:150
				__ [__ instanceof Form ? '__Form_reset' : 'reset']).call (__);     // form.jsxi:76
	...
	Form.prototype.__Form_fileInputHandler = function (){
		...
		(__ = this.__Form_element.findId ('file-clear').click (function (arg){     // form.jsxi:174
				...
				Crossdomain.request (inserted,                                     // form.jsxi:194
					...
					function (arg){                                                // ...
						if (arg && !__that.__Form_file)                            // form.jsxi:186
							__that.__Form_setFile ({                               // form.jsxi:192
								name: name + '.' + extension,                      // ...
		...
		this.__Form_element.findId ('submit').click (function (arg){               // form.jsxi:282
			...
			if (arg.which === 1){                                                  // form.jsxi:220
				var input = __that.__Form_element.findId ('file-input')[0],        // form.jsxi:227
					...
					subject = __that.__Form_element.findId ('subject').val (),     // form.jsxi:223
					message = __that.__Form_element.findId ('message').val (),     // form.jsxi:224
				...
				loading = (__ = new Message ('loading', 'Пожалуйста, подождите...'),
					__ [__ instanceof Form ? '__Form_show' : 'show']).call (__);   // form.jsxi:76
				...
				new SendRequest (__that.__Form_section,                            // form.jsxi:281
					...
					if (data === null){                                            // form.jsxi:264
						...
						if (__that.__Form_thread === undefined)                    // form.jsxi:273
							Statistics.threadCreated (__that.__Form_section);      // form.jsxi:274
						else
		...
		detSage.click (function (arg){                                             // form.jsxi:292
			if (arg.which === 1){                                                  // form.jsxi:288
				...
				if (Preferences.get ('sage-button-save'))                          // form.jsxi:290
					Preferences.set ('form-sage', $(this).hasClass ('active'));    // form.jsxi:291
			}
		});
	...
	Form.prototype.__Form_changeHandler = function (){
		...
		this.__Form_element.findId ('name').on ('change',                          // form.jsxi:307
			function (arg){                                                        // form.jsxi:304
				return Preferences.set ('form-previous-name', $(this).val ());     // form.jsxi:306
	...
	Form.prototype.__Form_styleHandler = function (){
		...
		function quote (){                                                         // form.jsxi:336
			...
			textarea.value = before + selected + after.substring (close.length);   // form.jsxi:350
			textarea.selectionStart = lastIndex + 1;                               // form.jsxi:351
			temp = textarea.value.indexOf ('\n', selected.length + lastIndex + 1);
			textarea.selectionEnd = temp !== - 1 ? temp : textarea.value.length;   // form.jsxi:353
	...
	Form.prototype.__Form_resizable = function (){
		...
		message.on ('mouseup mousemove',                                           // form.jsxi:391
			function (arg){                                                        // form.jsxi:382
				var newWidth = message.width (), newHeight = message.height ();    // form.jsxi:384
...
ImageExpand = function (){                                                         // imageExpand.jsxi:1
	...
	function collapse (_element){                                                  // imageExpand.jsxi:6
		...
		if (element.hasClass ('expanded')){                                        // imageExpand.jsxi:10
			post = Posts.get (element.closest ('[data-post]').data ('post'));      // imageExpand.jsxi:11
	...
	function expand (_element){                                                    // imageExpand.jsxi:27
		var type = Preferences.get ('expand-type'),                                // imageExpand.jsxi:34
			...
			post = Posts.get (element.closest ('[data-post]').data ('post')),      // imageExpand.jsxi:30
		...
		switch (type){                                                             // imageExpand.jsxi:58
			case 'expand':                                                         // imageExpand.jsxi:59
				element.addClass ('expanded').attr ({                              // imageExpand.jsxi:66
					width: fullWidth,                                              // ...
			...
			case 'center':                                                         // imageExpand.jsxi:68
				...
				if (!element.next ().hasClass ('center')){                         // imageExpand.jsxi:70
					...
					element.clone ().addClass ('center').addClass ('fading').attr ({
						...
						draggable: false
					}).css ({                                                      // imageExpand.jsxi:84
						left: (windowWidth - fullWidth) / 2,                       // ...
						top: (windowHeight - fullHeight) / 2
						...
						function (event){                                          // ...
							...
							var element = $(this),                                 // imageExpand.jsxi:103
								...
								oldWidth = parseFloat (element.css ('width')),     // imageExpand.jsxi:100
								oldHeight = parseFloat (element.css ('height')),   // imageExpand.jsxi:101
							...
							$(this).css ({                                         // imageExpand.jsxi:117
								left: oldLeft + (oldWidth - width) / 2,            // ...
...
HiddensWindow = function (){                                                       // hiddensWindow.jsxi:1
	...
	HiddensWindow.prototype.__HiddensWindow_params = function (){
		return {                                                                   // hiddensWindow.jsxi:50
			threads: Hiddens.sorted (),                                            // ...
	...
	HiddensWindow.prototype.click = function (button, key, param){
		switch (key){                                                              // hiddensWindow.jsxi:59
			case 'unhide-all':                                                     // hiddensWindow.jsxi:60
				this.__element.find ('input[data-target]').each (function (arg){   // hiddensWindow.jsxi:63
...
PreferencesWindow = function (){                                                   // preferencesWindow.jsxi:1
	...
	PreferencesWindow.prototype.__PreferencesWindow_setStyles = function (data){
		var select = this.__element.find ('[data-custom-setting=\"theme\"]'),      // preferencesWindow.jsxi:130
		...
		if (!found)                                                                // preferencesWindow.jsxi:137
			data.push ({                                                           // preferencesWindow.jsxi:141
				group: 'Кастомные стили',                                          // ...
				styles: [ { url: current, name: 'Текущий' } ]
			});
	...
	PreferencesWindow.prototype.__PreferencesWindow_processThemeSelect = function (select){
		return $.ajax ({                                                           // preferencesWindow.jsxi:211
			url: '/clin/styles/styles.json',                                       // ...
...
AuthorizePage = function (){                                                       // authorizePage.jsxi:1
	var AuthorizePage = function (){}, 
		phrases = [                                                                // authorizePage.jsxi:44
			'Дерпи не грустит и ты не грусти.',                                    // ...
			...
			'Пони разные важны, пони разные нужны.'
		];
	...
	AuthorizePage.prototype.build = function (data){
		return Mustache.authorizePage ({                                           // authorizePage.jsxi:59
			host: location.host,                                                   // ...
			phrase: phrases [phrases.length * Math.random () | 0]
		});
	};
	...
	AuthorizePage.prototype.__AuthorizePage_requestPassword = function (){
		...
		this.__AuthorizePage_buttonInput.click (function (arg){                    // authorizePage.jsxi:151
			if (arg.which === 1){                                                  // authorizePage.jsxi:127
				var login = __that.__AuthorizePage_loginInput.val ().trim (),      // authorizePage.jsxi:129
...
Panel = function (){                                                               // panel.jsxi:1
	var Panel = function (){                                                       // panel.jsxi:15
		...
		this.__Panel_element = $(Mustache.panel ()).appendTo (document.body);      // panel.jsxi:16
	...
	Panel.prototype.__Panel_rebuild = function (){
		...
		switch (this.__Panel_mode){                                                // panel.jsxi:76
			...
			case 'section':                                                        // panel.jsxi:68
				html = Mustache.panelSection ({                                    // panel.jsxi:72
			...
			case 'thread':                                                         // panel.jsxi:76
				html = Mustache.panelThread ({                                     // panel.jsxi:81
					backUrl: '/' + this.__Panel_section + '/',                     // ...
...
Post = function (){                                                                // post.jsxi:1
	var Post = function (section, id){                                             // post.jsxi:9
		...
		if (!data){                                                                // post.jsxi:12
			...
			new PostRequest (section, id).send (__bo (this, '__Post_loaded'));     // post.jsxi:14
		} else
	...
	Post.prototype.__Post_fixPopupStyles = function (){
		...
		this.__Post_element.css ({                                                 // post.jsxi:87
			top: parseInt (this.__Post_element.css ('top')) + dy,                  // ...
	...
	Post.buildHtml = function (params, override){                                  // post.jsxi:233
		...
		return Mustache.post ({                                                    // post.jsxi:253
			...
			timeout = setTimeout (function (arg){                                  // post.jsxi:303
				...
				function mouseleave (){                                            // post.jsxi:296
					return timeout = setTimeout (function (arg){                   // post.jsxi:300
						post.removeClass ('visible').timeout (function (arg){      // post.jsxi:298
							return post.remove ();                                 // ...
						}, 
						300);                                                      // ...
	...
	(function (arg){                                                               // post.jsxi:102
		...
		Preferences.on ('use-full-images use-full-gifs',                           // post.jsxi:118
			function (arg){                                                        // post.jsxi:106
				...
				$('.post > .content, .thread > .content').each (function (arg){    // post.jsxi:117

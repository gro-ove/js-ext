...
function doClasses (statements, callback){                                         // do_classes.jsxi:1
	...
	function processClassesMethods (){                                             // do_classes.jsxi:343
		function processClassMethod (classEntry, methodEntry){                     // do_classes.jsxi:344
			...
			function processMemberExpression (obj, parent, preparent){             // do_classes.jsxi:507
				...
				if (!obj.computed){                                                // do_classes.jsxi:513
					...
					if (member){                                                   // do_classes.jsxi:516
						...
						} else if (0 && member.publicMode !== 'public'){           // do_classes.jsxi:524
							if (parent instanceof Array && preparent)              // do_classes.jsxi:525
								parent = preparent;                                // do_classes.jsxi:526
							
							if (obj.object.type === Syntax.Identifier){            // do_classes.jsxi:528
								obj.computed = true;                               // do_classes.jsxi:529
								obj.property = conditionalExpression (binaryExpression (obj.object, 'instanceof', member.className.name), 
									stringLiteralWithQuotes (member.id.name),      // do_classes.jsxi:532
									stringLiteralWithQuotes (obj.property.name));
								process (obj.object, obj);                         // do_classes.jsxi:535
							} else if (parent.type === Syntax.AssignmentExpression){
								second = $.extend (true, {}, 
									parent);                                       // do_classes.jsxi:537
								
								for (var key in parent){                           // do_classes.jsxi:538
									var value = parent [key];
									
									if (value === obj)                             // do_classes.jsxi:539
										second [key] = memberExpression ('__',     // do_classes.jsxi:540
								...
								set (parent,                                       // do_classes.jsxi:545
									sequenceExpression ([ assignmentExpression ('__', obj.object), second ]));
								process (obj.object, obj);                         // do_classes.jsxi:550
								temp = true;                                       // do_classes.jsxi:552
							} else {
								set (obj,                                          // do_classes.jsxi:554
									sequenceExpression ([                          // do_classes.jsxi:554
										assignmentExpression ('__', obj.object), 
										memberExpression ('__',                    // do_classes.jsxi:556
											conditionalExpression (binaryExpression ('__', 'instanceof', member.className.name), 
												stringLiteralWithQuotes (member.id.name), 
												stringLiteralWithQuotes (obj.property.name)), 
											true)
									]));
								process (obj);                                     // do_classes.jsxi:562
								...
								temp = true;                                       // do_classes.jsxi:569
							}
							
							if (temp && !currentFunction.hasTempVariable){         // do_classes.jsxi:572
								currentFunction.body.body.unshift (oneVariableDeclaration ('__'));
								currentFunction.hasTempVariable = true;            // do_classes.jsxi:574
							}
							return;
						}
					}
				...
				process (obj.object, obj);                                         // do_classes.jsxi:583
				
				if (obj.computed)                                                  // do_classes.jsxi:586
					process (obj.property, obj);                                   // do_classes.jsxi:587
			}
			
			function processSuperExpression (obj, parent){                         // do_classes.jsxi:590
				if (currentFunction !== methodEntry && obj.callee === null)        // do_classes.jsxi:595
					throw new Error ('Not implemented');                           // do_classes.jsxi:596
				
				var currentClass = classEntry;
				
				for (var i = 0; i < obj ['super']; i ++){                          // do_classes.jsxi:602
					currentClass = currentClass.dependsOn.parent;                  // do_classes.jsxi:603
					
					if (!currentClass)                                             // do_classes.jsxi:606
				...
				if (!method)                                                       // do_classes.jsxi:613
					throw new TypeError ('Super method not found', obj);           // do_classes.jsxi:614
				
				if (method.static)                                                 // do_classes.jsxi:616
					throw new TypeError ('This method is static', obj);            // do_classes.jsxi:617
				
				var target;
				
				if (method.id.name [0] !== '@'){                                   // do_classes.jsxi:622
					target = memberExpression (memberExpression (currentClass.id, 'prototype'), 
						method.id.name);                                           // do_classes.jsxi:624
				} else {
					target = currentClass.id.name;                                 // do_classes.jsxi:627
				}
				
				if (obj.arguments === null){                                       // do_classes.jsxi:631
					obj.callee = memberExpression (target, 'apply');               // do_classes.jsxi:632
					obj.arguments = [ identifier ('arguments') ];                  // do_classes.jsxi:633
				} else
					obj.callee = memberExpression (target, 'call');                // do_classes.jsxi:635
				
				obj.arguments.unshift (getThis ());                                // do_classes.jsxi:638
			}
			
			function process (obj, parent, preparent){                             // do_classes.jsxi:641
				if (typeof obj === 'object' && obj !== null){                      // do_classes.jsxi:642
					if (obj instanceof Array){                                     // do_classes.jsxi:645
						for (var __j = 0; __j < obj.length; __j ++){               // do_classes.jsxi:647
							var child = obj [__j];
							
							process (child, obj, parent);                          // do_classes.jsxi:648
						}
					} else if ('type' in obj){                                     // do_classes.jsxi:650
						switch (obj.type){                                         // do_classes.jsxi:653
							case Syntax.FunctionDeclaration:                       // do_classes.jsxi:654
								
							case Syntax.FunctionExpression:                        // do_classes.jsxi:655
								processFunction (obj, parent);                     // do_classes.jsxi:656
								
								break;
							case Syntax.Property:                                  // do_classes.jsxi:659
								processProperty (obj, parent);                     // do_classes.jsxi:660
								
								break;
							case Syntax.Identifier:                                // do_classes.jsxi:663
								processIdentifier (obj, parent);                   // do_classes.jsxi:664
								
								break;
							case Syntax.AssignmentExpression:                      // do_classes.jsxi:667
								processAssignmentExpression (obj, parent);         // do_classes.jsxi:668
								
								break;
							case Syntax.MemberExpression:                          // do_classes.jsxi:671
								processMemberExpression (obj, parent, preparent);
								
								break;
							case Syntax.CallExpression:                            // do_classes.jsxi:675
								if ('super' in obj)                                // do_classes.jsxi:676
									processSuperExpression (obj, parent);          // do_classes.jsxi:677
							default:
								for (var key in obj){                              // do_classes.jsxi:681
									var value = obj [key];
									
									process (value, obj);                          // do_classes.jsxi:683
								}
						}
					}
				}
			...
			process (methodEntry);                                                 // do_classes.jsxi:690
		}
		
		function processClassMethods (classEntry){                                 // do_classes.jsxi:693
			...
			
			{
				...
				for (var name in __k){
					...
					if (member.method && !member.abstract && member.className === classEntry.id)
						processClassMethod (classEntry, member);                   // do_classes.jsxi:700
				}
		...
		for (var __l = 0; __l < classes.length; __l ++){                           // do_classes.jsxi:704
			var classEntry = classes [__l];
			
			processClassMethods (classEntry);                                      // do_classes.jsxi:705
		}
	}
	
	function processClasses (){                                                    // do_classes.jsxi:708
		function processClass (classEntry){                                        // do_classes.jsxi:710
			function classMode (){                                                 // do_classes.jsxi:712
				if (classEntry.childs.length === 0 && !classEntry.dependsOn.parent && objectMembers.length === 0 && constructor.body.body.length === 0){
					if (staticFields.length > 0 || staticMethods.length > 0)       // do_classes.jsxi:718
						return OutputMode.Static;                                  // do_classes.jsxi:719
					
					if (initializer.body.body.length > 0)                          // do_classes.jsxi:722
						return OutputMode.InitializerOnly;                         // do_classes.jsxi:723
					return OutputMode.Empty;                                       // do_classes.jsxi:725
				}
				return OutputMode.Default;                                         // do_classes.jsxi:728
			}
			
			console.assert (!classEntry.elements, 'Already processed');            // do_classes.jsxi:732
			
			var constructor = classEntry.members ['@constructor'],                 // do_classes.jsxi:735
				initializer = classEntry.members ['@initializer'];                 // do_classes.jsxi:736
			
			var filtered = filter (classEntry,                                     // do_classes.jsxi:739
					function (arg){                                                // do_classes.jsxi:739
						return arg.className === classEntry.id && arg.id.name [0] !== '@';
					}), 
				objectMembers = filtered.filter (function (arg){                   // do_classes.jsxi:740
					return !arg.static;                                            // do_classes.jsxi:740
				}), 
				staticMembers = filtered.filter (function (arg){                   // do_classes.jsxi:741
					return arg.static;                                             // do_classes.jsxi:741
				});
			
			var objectMethods = objectMembers.filter (function (arg){              // do_classes.jsxi:744
					return arg.method;                                             // do_classes.jsxi:744
				}), 
				objectFields = objectMembers.filter (function (arg){               // do_classes.jsxi:745
					return !arg.method;                                            // do_classes.jsxi:745
				}), 
				staticMethods = staticMembers.filter (function (arg){              // do_classes.jsxi:746
					return arg.method;                                             // do_classes.jsxi:746
				}), 
				staticFields = staticMembers.filter (function (arg){               // do_classes.jsxi:747
					return !arg.method;                                            // do_classes.jsxi:747
				});
			
			constructor.id = null;                                                 // do_classes.jsxi:750
			initializer.id = null;                                                 // do_classes.jsxi:751
			
			if (!classEntry.params.abstract && filter (classEntry,                 // do_classes.jsxi:754
				function (arg){                                                    // do_classes.jsxi:754
					return arg.abstract;                                           // do_classes.jsxi:754
				}).length > 0)                                                     // do_classes.jsxi:754
				classEntry.params.abstract = true;                                 // do_classes.jsxi:755
			
			if (classEntry.params.abstract)                                        // do_classes.jsxi:758
				constructor.body.body.unshift (ifStatement (binaryExpression (memberExpression (thisExpression (), identifier ('constructor')), 
					'===',                                                         // do_classes.jsxi:761
					classEntry.id.name),                                           // do_classes.jsxi:761
				throwStatement (newExpression ('Error',                            // do_classes.jsxi:762
					[
			...
			if (mode === OutputMode.Empty)                                         // do_classes.jsxi:770
				return [
					oneVariableDeclaration (classEntry.id.name, objectExpression ([]))
				];
			
			if (mode === OutputMode.InitializerOnly)                               // do_classes.jsxi:774
				return [
					oneVariableDeclaration (classEntry.id.name, callExpression (initializer))
				];
			
			var anonymousFunction = staticMembers.filter (function (arg){          // do_classes.jsxi:778
					return arg.publicMode === 'private';                           // do_classes.jsxi:778
				}).length > 0,                                                     // do_classes.jsxi:778
				result,                                                            // do_classes.jsxi:779
				mainObj;                                                           // do_classes.jsxi:780
			
			if (mode === OutputMode.Default){                                      // do_classes.jsxi:782
				...
				if (classEntry.dependsOn.parent)                                   // do_classes.jsxi:789
					result.push (expressionStatement (callExpression ('__prototypeExtend', 
						[ classEntry.id.name, classEntry.dependsOn.parent.id.name ])));
				
				for (var __m = 0; __m < objectFields.length; __m ++){              // do_classes.jsxi:793
					var field = objectFields [__m];
					
					{};
				}
				
				for (var __n = 0; __n < objectMethods.length; __n ++){             // do_classes.jsxi:796
					var method = objectMethods [__n];
					
					if (!method.abstract)                                          // do_classes.jsxi:797
						result.push (assignmentStatement (memberExpression (memberExpression (classEntry.id.name, 'prototype'), 
							method.id),                                            // do_classes.jsxi:799
						functionExpression (null, method.params, method.body)));   // do_classes.jsxi:800
				}
				
				for (var __o = 0; __o < staticFields.length; __o ++){              // do_classes.jsxi:804
					var field = staticFields [__o];
					
					if (field.publicMode === 'private')                            // do_classes.jsxi:805
						result [0].declarations.push (field);                      // do_classes.jsxi:806
					else
						result.push (assignmentStatement (memberExpression (classEntry.id.name, field.id), 
							field.init || 'undefined'));                           // do_classes.jsxi:808
				}
				
				for (var __p = 0; __p < staticMethods.length; __p ++){             // do_classes.jsxi:812
					var method = staticMethods [__p];
					
					if (method.publicMode === 'private')                           // do_classes.jsxi:813
						result.push (method);                                      // do_classes.jsxi:814
					else
				...
				result = [                                                         // do_classes.jsxi:822
					oneVariableDeclaration (classEntry.id, objectExpression (properties))
				];
				
				for (var __q = 0; __q < staticFields.length; __q ++){              // do_classes.jsxi:825
					var field = staticFields [__q];
					
					if (field.publicMode === 'private')                            // do_classes.jsxi:826
						result [0].declarations.push (field);                      // do_classes.jsxi:827
					else
						properties.push (property (field.id, field.init || 'undefined'));
				}
				
				for (var __r = 0; __r < staticMethods.length; __r ++){             // do_classes.jsxi:833
					var method = staticMethods [__r];
					
					if (method.publicMode === 'private')                           // do_classes.jsxi:834
						result.push (method);                                      // do_classes.jsxi:835
					else
						properties.push (property (method.id,                      // do_classes.jsxi:837
							functionExpression (null, method.params, method.body)));
				}
			}
			
			if (initializer.body.body.length > 0)                                  // do_classes.jsxi:842
				result.push (expressionStatement (callExpression (initializer)));
			
			if (anonymousFunction){                                                // do_classes.jsxi:846
				result.push (returnStatement (classEntry.id.name));                // do_classes.jsxi:847
				return [
					oneVariableDeclaration (classEntry.id, callFunctionExpression (result))
				];
			}
			return result;                                                         // do_classes.jsxi:851
		}
		
		for (var __s = 0; __s < classes.length; __s ++){                           // do_classes.jsxi:854
			var classEntry = classes [__s];
			
			classEntry.statements = processClass (classEntry);                     // do_classes.jsxi:855
		}
	}
	
	function sortAndInsertClasses (){                                              // do_classes.jsxi:858
		var sorted = classes.sort (function (a, b){                                // do_classes.jsxi:859
			return b.weight - a.weight;                                            // do_classes.jsxi:859
		});
		
		for (var __t = 0; __t < sorted.length; __t ++){                            // do_classes.jsxi:860
			var current = sorted [__t];
			
			current.root.unshift ({                                                // do_classes.jsxi:861
				type: Syntax.ClassDeclaration,                                     // do_classes.jsxi:861
				name: current.id.name,                                             // do_classes.jsxi:863
	...
	
	{
		...
		for (var __u = 0; __u < __v.length; __u ++){
			...
			addClass (found);                                                      // do_classes.jsxi:869
		}
		
		__v = undefined;
	}
	
	if (classes.length > 0){                                                       // do_classes.jsxi:871
		preprocessClasses ();                                                      // do_classes.jsxi:872
		connectClasses ();                                                         // do_classes.jsxi:873
		processClassesMembers ();                                                  // do_classes.jsxi:874
		processClassesMethods ();                                                  // do_classes.jsxi:875
		processClasses ();                                                         // do_classes.jsxi:876
		sortAndInsertClasses ();                                                   // do_classes.jsxi:877
		callback (helpers.helpers);                                                // do_classes.jsxi:879
	} else
		callback ();                                                               // do_classes.jsxi:881
}
...
function parseClassMembers (params, dependsOn){                                    // parse_class.jsxi:88
	...
	function parseField (){                                                        // parse_class.jsxi:108
		...
		{
			var __11 = parseVariableDeclarators ();
			
			for (var __10 = 0; __10 < __11.length; __10 ++){
				var entry = __11 [__10];
...
function parsePrimaryExpression (){                                                // parse_expressions.jsxi:575
	...
	switch (token.type){                                                           // parse_expressions.jsxi:578
		case Token.Identifier:                                                     // parse_expressions.jsxi:579
			...
			return mark ({ type: Syntax.Identifier, name: token.value }, token);   // parse_expressions.jsxi:581
		case Token.Keyword:                                                        // parse_expressions.jsxi:583
			if (token.value === 'this'){                                           // parse_expressions.jsxi:584
				lex ();                                                            // parse_expressions.jsxi:585
				return mark ({ type: Syntax.ThisExpression }, token);              // parse_expressions.jsxi:586
			}
			
			if (token.value === 'function')                                        // parse_expressions.jsxi:589
				return parseFunctionExpression ();                                 // parse_expressions.jsxi:590
			
			if (token.value === 'lambda')                                          // parse_expressions.jsxi:592
				return parseLambdaExpression ();                                   // parse_expressions.jsxi:593
			
			break;
		case Token.StringLiteral:                                                  // parse_expressions.jsxi:597
			lex ();                                                                // parse_expressions.jsxi:598
			
			if (lookahead ().value === '(')                                        // parse_expressions.jsxi:599
				return parseComplexString (token);                                 // parse_expressions.jsxi:600
			else
				return mark ({ type: Syntax.StringLiteral, value: token.value }, token);
		case Token.NumericLiteral:                                                 // parse_expressions.jsxi:604
			lex ();                                                                // parse_expressions.jsxi:605
			return numericLiteral (token.value);                                   // parse_expressions.jsxi:606
		case Token.BooleanLiteral:                                                 // parse_expressions.jsxi:608
			lex ();                                                                // parse_expressions.jsxi:609
			return booleanLiteral (token.value);                                   // parse_expressions.jsxi:610
		case Token.NullLiteral:                                                    // parse_expressions.jsxi:612
			lex ();                                                                // parse_expressions.jsxi:613
			return nullLiteral ();                                                 // parse_expressions.jsxi:614
		case Token.UndefinedLiteral:                                               // parse_expressions.jsxi:616
			lex ();                                                                // parse_expressions.jsxi:617
			return undefinedLiteral ();                                            // parse_expressions.jsxi:618
		case Token.Punctuator:                                                     // parse_expressions.jsxi:620
			switch (token.value){                                                  // parse_expressions.jsxi:621
				case '[':                                                          // parse_expressions.jsxi:622
					return parseArrayInitialiser ();                               // parse_expressions.jsxi:623
				case '{':                                                          // parse_expressions.jsxi:625
					return parseObjectInitialiser ();                              // parse_expressions.jsxi:626
				case '(':                                                          // parse_expressions.jsxi:628
					return parseGroupExpression ();                                // parse_expressions.jsxi:629
				case '/':                                                          // parse_expressions.jsxi:631
					lex ();                                                        // parse_expressions.jsxi:632
					return readRegexp ();                                          // parse_expressions.jsxi:633
			}
		default:
			unexpected (token);                                                    // parse_expressions.jsxi:637
	}
}
...
function parseFunction (options){                                                  // parse_function.jsxi:10
	...
	if (!options.empty){                                                           // parse_function.jsxi:26
		body = parseFunctionElements (options.noSemicolon);                        // parse_function.jsxi:27
	} else {
		body = null;                                                               // parse_function.jsxi:29
		consumeSemicolon ();                                                       // parse_function.jsxi:30
	}
	return mark ((options.declaration ? functionDeclaration : functionExpression)(id, params, body), 
		token);                                                                    // parse_function.jsxi:33
}

function parseFunctionExpression (){                                               // parse_function.jsxi:36
	var oldNoReturn = state.noReturn, result;
	
	state.noReturn = false;                                                        // parse_function.jsxi:38
	result = parseFunction ();                                                     // parse_function.jsxi:39
	state.noReturn = oldNoReturn;                                                  // parse_function.jsxi:40
	return result;                                                                 // parse_function.jsxi:41
}

function parseFunctionDeclaration (){                                              // parse_function.jsxi:44
	var oldNoReturn = state.noReturn, result;
	
	state.noReturn = false;                                                        // parse_function.jsxi:46
	result = parseFunction ({ id: true, declaration: true });                      // parse_function.jsxi:47
	state.noReturn = oldNoReturn;                                                  // parse_function.jsxi:48
	return result;                                                                 // parse_function.jsxi:49
}

function parseLambdaExpression (){                                                 // parse_function.jsxi:52
	var oldNoReturn = state.noReturn, result;
	
	state.noReturn = false;                                                        // parse_function.jsxi:54
	result = parseFunction ({                                                      // parse_function.jsxi:55
		id: false,                                                                 // parse_function.jsxi:55
		keyword: 'lambda',                                                         // parse_function.jsxi:55
		optionalParams: [ identifier ('arg') ],                                    // parse_function.jsxi:55
		noSemicolon: true
	});
...
function parseFunctionArguments (){                                                // parse_function.jsxi:60
	var name, params = [], comma = {};
	
	expect ('(');                                                                  // parse_function.jsxi:63
	
	while (!match (')')){                                                          // parse_function.jsxi:65
		if (params.length)                                                         // parse_function.jsxi:66
			parseOptionalComma (comma);                                            // parse_function.jsxi:67
		
		name = parseIdentifier ();                                                 // parse_function.jsxi:69
		
		if (matchLex ('='))                                                        // parse_function.jsxi:70
			name.defaultValue = parseAssignmentExpression ();                      // parse_function.jsxi:71
		
		params.push (name);                                                        // parse_function.jsxi:73
	}
	
	expect (')');                                                                  // parse_function.jsxi:76
	return params;                                                                 // parse_function.jsxi:77
}

function parseOptionalFunctionArguments (){                                        // parse_function.jsxi:80
	return attemptTo (parseFunctionArguments, null, 
		!match ('('));                                                             // parse_function.jsxi:81
}

function parseFunctionElements (noSemicolon){                                      // parse_function.jsxi:83
	var oldPreventSequence = state.preventSequence, result;
	
	if (match ('{')){                                                              // parse_function.jsxi:86
		expect ('{');                                                              // parse_function.jsxi:87
		attemptTo (function (arg){                                                 // parse_function.jsxi:89
			result = [ returnStatement (objectExpression (parseObjectContent ())) ];
			consumeSemicolon ();                                                   // parse_function.jsxi:92
		}, 
		function (arg){                                                            // parse_function.jsxi:94
			state.preventSequence = false;                                         // parse_function.jsxi:95
			result = [];                                                           // parse_function.jsxi:96
			
			while (!match ('}'))                                                   // parse_function.jsxi:98
				result.push (parseStatement ());                                   // parse_function.jsxi:99
		}, 
		lookahead ().type !== Token.Literal && lookahead ().type !== Token.Identifier);
		expect ('}');                                                              // parse_function.jsxi:103
	} else if (matchLex (';')){                                                    // parse_function.jsxi:104
		result = [];                                                               // parse_function.jsxi:105
	} else if (!match (']') && !match (')') && !match ('}') && !match (',')){      // parse_function.jsxi:106
		state.preventSequence = true;                                              // parse_function.jsxi:107
		result = [ setReturnStatement (parseStatement ()) ];                       // parse_function.jsxi:108
	}
	
	if (!noSemicolon)                                                              // parse_function.jsxi:111
		matchLex (';');                                                            // parse_function.jsxi:112
	
	state.preventSequence = oldPreventSequence;                                    // parse_function.jsxi:114
	return blockStatement (result);                                                // parse_function.jsxi:115
}

function setReturnStatement (data){                                                // parse_function.jsxi:118
	if (data)                                                                      // parse_function.jsxi:119
		if (data.type === Syntax.ExpressionStatement){                             // parse_function.jsxi:120
			data.type = Syntax.ReturnStatement;                                    // parse_function.jsxi:121
			data.argument = data.expression;                                       // parse_function.jsxi:122
			delete data.expression;                                                // parse_function.jsxi:123
		} else if (data.type === Syntax.IfStatement){                              // parse_function.jsxi:124
			setReturnStatement (data.consequent);                                  // parse_function.jsxi:125
			setReturnStatement (data.alternate);                                   // parse_function.jsxi:126
		} else if (data.type === Syntax.LabelledStatement){                        // parse_function.jsxi:127
			setReturnStatement (data.body);                                        // parse_function.jsxi:128
		} else if (data.type === Syntax.BlockStatement && data.single){            // parse_function.jsxi:129
			setReturnStatement (data.body [0]);                                    // parse_function.jsxi:130
		} else if (data.type === Syntax.TryStatement){                             // parse_function.jsxi:131
			setReturnStatement (data.block);                                       // parse_function.jsxi:132
			
			if (data.handlers && data.handlers [0])                                // parse_function.jsxi:133
				setReturnStatement (data.handlers [0].body);                       // parse_function.jsxi:134
			
			if (data.finalizer)                                                    // parse_function.jsxi:135
				setReturnStatement (data.finalizer);                               // parse_function.jsxi:136
		}
	return data;                                                                   // parse_function.jsxi:139
}
...
File.DEBUG_MODE = true;                                                            // file.jsxi:1

function File (root, fullpath){                                                    // file.jsxi:3
	console.assert (!fileStorage.exists (fullpath), 'File already processed');     // file.jsxi:4
	
	if (fullpath === undefined){                                                   // file.jsxi:6
		this.fullpath = path.resolve (root);                                       // file.jsxi:7
		this.root = path.dirname (this.fullpath);                                  // file.jsxi:8
	} else {
		this.fullpath = fullpath;                                                  // file.jsxi:10
		this.root = root;                                                          // file.jsxi:11
	}
	
	this.dirname = path.dirname (this.fullpath);                                   // file.jsxi:14
	this.filename = path.basename (this.fullpath);                                 // file.jsxi:15
	this.state = File.STATE_INITIAL;                                               // file.jsxi:16
	this.imports = [];                                                             // file.jsxi:17
	this.weightCalculating = false;                                                // file.jsxi:18
	fileStorage.add (this);                                                        // file.jsxi:20
}

File.STATE_WAITING = - 1;                                                          // file.jsxi:23
File.STATE_MACRO_WAITING = - 2;                                                    // file.jsxi:24
File.STATE_INITIAL = 0;                                                            // file.jsxi:25
File.STATE_LOADED = 1;                                                             // file.jsxi:26
File.STATE_MACROS = 2;                                                             // file.jsxi:27
File.STATE_FINISHED = 3;                                                           // file.jsxi:28
addLog (File,                                                                      // file.jsxi:30
	1, 
	function (arg){                                                                // file.jsxi:30
		return this.filename;                                                      // file.jsxi:30
	});

var lookingAt = [ { root: path.resolve (__dirname, 'library') } ];                 // file.jsxi:32

File.find = function (child){                                                      // file.jsxi:36
	return File.prototype.find (child);                                            // file.jsxi:37
};
File.prototype.find = function (child){                                            // file.jsxi:40
	function getByMask (temp){                                                     // file.jsxi:41
		var dirname = path.dirname (temp),                                         // file.jsxi:44
			regExp = new RegExp ('^' + path.basename (temp).replace (/\*/g, '.*').replace (/\?/g, '.') + '$', 
				'i'),                                                              // file.jsxi:45
			files = fs.readdirSync (dirname),                                      // file.jsxi:46
			filtered = files.filter (RegExp.prototype.test.bind (regExp)).map (function (arg){
				return path.resolve (dirname, arg);                                // file.jsxi:47
			});
		return filtered;                                                           // file.jsxi:49
	}
	
	function findInFolder (root, current, child){                                  // file.jsxi:52
		if (current === undefined)                                                 // file.jsxi:52
			current = root;                                                        // file.jsxi:52
	
		console.assert (current.indexOf (root) === 0, 'Invalid state');            // file.jsxi:53
		
		while (current.indexOf (root) === 0){                                      // file.jsxi:55
			var temp = path.resolve (current, child + '.jsxi'),                    // file.jsxi:56
				match = temp.search (/[\*\?]/);                                    // file.jsxi:57
			
			if (match !== - 1){                                                    // file.jsxi:59
				var filtered = getByMask (temp);
				
				if (filtered.length)                                               // file.jsxi:61
					return filtered;                                               // file.jsxi:62
			} else if (fs.existsSync (temp))                                       // file.jsxi:63
				return [ temp ];
			
			current = path.dirname (current);                                      // file.jsxi:66
		}
	}
	
	{
		var __15 = this instanceof File ? [ { root: this.root, dirname: this.dirname } ].concat (lookingAt) : lookingAt;
		...
		for (var __14 = 0; __14 < __15.length; __14 ++){
			...
			if (temp)                                                              // file.jsxi:73
				return temp.map (function (arg){                                   // file.jsxi:74
					return fileStorage.get (arg) || new File (entry.root, arg);    // file.jsxi:74
				});
		}
...
File.prototype.weight = function (){                                               // file.jsxi:78
	if (this.weightCalculating)                                                    // file.jsxi:79
		return 0;
	
	this.weightCalculating = true;                                                 // file.jsxi:82
	
	var result = this.imports.reduce (function (a, b){                             // file.jsxi:83
		return a + b.weight ();                                                    // file.jsxi:83
	}, 
	1);
	
	this.weightCalculating = false;                                                // file.jsxi:84
	return result;                                                                 // file.jsxi:86
};
File.prototype.load = function (callback){                                         // file.jsxi:89
	console.assert (this.state == File.STATE_INITIAL,                              // file.jsxi:90
		'Wrong state (' + this.state + ')');                                       // file.jsxi:90
	this.state = File.STATE_MACRO_WAITING;                                         // file.jsxi:91
	fs.readFile (this.fullpath,                                                    // file.jsxi:93
		function (error, data){                                                    // file.jsxi:93
			if (error)                                                             // file.jsxi:94
				console.fatal (error);                                             // file.jsxi:95
			
			this.state = File.STATE_LOADED;                                        // file.jsxi:97
			this.content = String (data);                                          // file.jsxi:98
			this.log ('loaded',                                                    // file.jsxi:100
				this.content.length ? '(' + this.content.length + ' bytes)' : '(empty)');
			callback ();                                                           // file.jsxi:102
		}.bind (this));                                                            // file.jsxi:103
};
File.prototype.macros = function (callback){                                       // file.jsxi:106
	console.assert (this.state == File.STATE_LOADED,                               // file.jsxi:107
		'Wrong state (' + this.state + ')');                                       // file.jsxi:107
	this.state = File.STATE_WAITING;                                               // file.jsxi:108
	macrosProcess (this.content,                                                   // file.jsxi:110
		new Context (this),                                                        // file.jsxi:110
		function (arg){                                                            // file.jsxi:110
			this.log ('macro calls processed');                                    // file.jsxi:111
			this.state = File.STATE_MACROS;                                        // file.jsxi:113
			this.content = String (arg);                                           // file.jsxi:114
			callback ();                                                           // file.jsxi:116
		}.bind (this));                                                            // file.jsxi:117
};
File.prototype.parsing = function (callback){                                      // file.jsxi:120
	console.assert (this.state == File.STATE_MACROS,                               // file.jsxi:121
		'Wrong state (' + this.state + ')');                                       // file.jsxi:121
	this.state = File.STATE_WAITING;                                               // file.jsxi:122
	jsxParse (this.content,                                                        // file.jsxi:125
		{ filename: this.filename, initializationAllowed: true }, 
		function (parsed, helpers){                                                // file.jsxi:128
			this.log ('parsing processed');                                        // file.jsxi:129
			this.state = File.STATE_FINISHED;                                      // file.jsxi:131
			this.parsed = parsed;                                                  // file.jsxi:132
			this.helpers = helpers;                                                // file.jsxi:133
			callback ();                                                           // file.jsxi:135
		}.bind (this));                                                            // file.jsxi:136
};
File.prototype.process = function (callback){                                      // file.jsxi:143
	new Queue (this, Queue.MODE_SEQUENT).description ('file process').add (this.load).add (this.macros).add (this.parsing).run (function (arg){
		console.assert (this.state == File.STATE_FINISHED,                         // file.jsxi:150
			'Wrong state (' + this.state + ')');                                   // file.jsxi:150
		
		if (callback !== undefined)                                                // file.jsxi:151
			callback (this);                                                       // file.jsxi:152
	});
};
				...
				var oneline,                                                       // generator.jsxi:100
					...
					result = join (array,                                          // generator.jsxi:104
						forceWrap ? function (arg, index){                         // generator.jsxi:104
							...
							if (!indented)                                         // generator.jsxi:114
								console.log ('fail', arg);                         // generator.jsxi:115
							
							if (!forceWrap && indented.indexOf ('\n') !== - 1)     // generator.jsxi:116
								forceWrap = true;                                  // generator.jsxi:117
							return indented;                                       // generator.jsxi:118
						}, 
						joinString);                                               // generator.jsxi:119
				
				if (!forceWrap)                                                    // generator.jsxi:122
					oneline = result.replace (/\/\/\d+\n\t*/g, '');                // generator.jsxi:123
				
				if (forceWrap || !oneline || oneline.length > 60){                 // generator.jsxi:127
					if (insertSpaces){                                             // generator.jsxi:130
						comment = temp;                                            // generator.jsxi:131
						return end () + '\t' + result + end ();                    // generator.jsxi:132
					} else
						return result;                                             // generator.jsxi:134
				} else {
					comment = temp;                                                // generator.jsxi:137
					
					if (insertSpaces)                                              // generator.jsxi:140
						return ' ' + oneline + ' ';                                // generator.jsxi:141
					else
						return oneline;                                            // generator.jsxi:143
				}
			}
			
			function sub (obj){                                                    // generator.jsxi:147
				return obj.type === Syntax.BlockStatement ? child (obj) : obj.type === Syntax.EmptyStatement ? ';' : indent (obj);
			}
			
			if (!node || !node.type){                                              // generator.jsxi:150
				console.json (parent);                                             // generator.jsxi:151
				
				throw new Error ('Node = ' + node);                                // generator.jsxi:152
			}
			
			if (niceMode && comment === null && node.filename)                     // generator.jsxi:155
				comment = node.filename + ':' + node.lineNumber;                   // generator.jsxi:156
			
			var result, temp;
			
			switch (node.type){                                                    // generator.jsxi:160
				case Syntax.BooleanLiteral:                                        // generator.jsxi:162
					
				case Syntax.NullLiteral:                                           // generator.jsxi:163
					
				case Syntax.NumericLiteral:                                        // generator.jsxi:164
					
				case Syntax.RegexpLiteral:                                         // generator.jsxi:165
					
				case Syntax.StringLiteral:                                         // generator.jsxi:166
					
				case Syntax.UndefinedLiteral:                                      // generator.jsxi:167
					return node.value;                                             // generator.jsxi:168
				case Syntax.Identifier:                                            // generator.jsxi:170
					return node.name;                                              // generator.jsxi:171
				case Syntax.Property:                                              // generator.jsxi:173
					return child (node.key) + ': ' + child (node.value);           // generator.jsxi:174
				case Syntax.ThisExpression:                                        // generator.jsxi:176
					return 'this';                                                 // generator.jsxi:177
				case Syntax.MemberExpression:                                      // generator.jsxi:181
					result = child (node.object);                                  // generator.jsxi:182
					
					if (node.computed){                                            // generator.jsxi:183
						if (/\w$/.test (result))                                   // generator.jsxi:184
							result += ' ';                                         // generator.jsxi:185
						
						result += '[' + child (node.property) + ']';               // generator.jsxi:186
					} else
						result += '.' + child (node.property);                     // generator.jsxi:188
					return result;                                                 // generator.jsxi:189
				case Syntax.NewExpression:                                         // generator.jsxi:193
					result = 'new ';                                               // generator.jsxi:194
				case Syntax.CallExpression:                                        // generator.jsxi:196
					result = (result || '') + child (node.callee);                 // generator.jsxi:197
					result += /\w$/.test (result) ? ' (' : '(';                    // generator.jsxi:198
					temp = mapArray (node.arguments, ', ', false, 
						false);                                                    // generator.jsxi:199
					
					if (temp.match (/\n(\t*)/) && RegExp.$1.length > tabs.length + 1)
						temp = temp.replace (/\n\t/g, '\n');                       // generator.jsxi:201
					return result + temp + ')';                                    // generator.jsxi:202
				case Syntax.UnaryExpression:                                       // generator.jsxi:206
					if (node.prefix){                                              // generator.jsxi:207
						result = node.operator;                                    // generator.jsxi:208
						
						if (node.operator !== '!')                                 // generator.jsxi:209
							result += ' ';                                         // generator.jsxi:210
						
						result += child (node.argument);                           // generator.jsxi:211
					} else
						result = child (node.argument) + ' ' + node.operator;      // generator.jsxi:213
					return brackets (result);                                      // generator.jsxi:214
				case Syntax.AssignmentExpression:                                  // generator.jsxi:216
					
				case Syntax.BinaryExpression:                                      // generator.jsxi:217
					
				case Syntax.LogicalExpression:                                     // generator.jsxi:218
					return brackets (child (node.left) + ' ' + node.operator + ' ' + child (node.right));
				case Syntax.SequenceExpression:                                    // generator.jsxi:221
					return brackets (mapArray (node.expressions, ', '));           // generator.jsxi:222
				case Syntax.ConditionalExpression:                                 // generator.jsxi:224
					return brackets (child (node.test) + ' ? ' + child (node.consequent) + ' : ' + child (node.alternate));
				case Syntax.ArrayExpression:                                       // generator.jsxi:229
					return '[' + mapArray (node.elements, ', ', false, 
						true) + ']';                                               // generator.jsxi:230
				case Syntax.ObjectExpression:                                      // generator.jsxi:232
					return '{' + mapArray (node.properties, ', ', false, 
						true) + '}';                                               // generator.jsxi:233
				case Syntax.FunctionExpression:                                    // generator.jsxi:235
					if (node.id)                                                   // generator.jsxi:236
						result = 'function ' + child (node.id) + ' (';             // generator.jsxi:237
					else
						result = 'function (';                                     // generator.jsxi:239
					return result + mapArray (node.params, ', ') + ')' + child (node.body);
				case Syntax.ClassDeclaration:                                      // generator.jsxi:244
					result = '/* Class "' + node.name + '" declaration */';        // generator.jsxi:245
					
					{
						var __19 = node.statements;
						
						for (var __18 = 0; __18 < __19.length; __18 ++){
							var statement = __19 [__18];
					...
					return result;                                                 // generator.jsxi:248
				case Syntax.FunctionDeclaration:                                   // generator.jsxi:250
					return 'function ' + child (node.id) + ' (' + mapArray (node.params, ', ') + ')' + child (node.body);
				case Syntax.VariableDeclaration:                                   // generator.jsxi:253
					temp = mapArray (node.declarations, ', ');                     // generator.jsxi:254
					
					if (node.declarations.length === 1 && temp.match (/\n(\t*)/) && RegExp.$1.length > tabs.length + 1)
						temp = temp.replace (/\n\t/g, '\n');                       // generator.jsxi:256
					
					if (parent.type === Syntax.ForStatement || parent.type === Syntax.ForInStatement)
						return 'var ' + temp;                                      // generator.jsxi:258
					else
						return 'var ' + temp + ';';                                // generator.jsxi:260
				case Syntax.VariableDeclarator:                                    // generator.jsxi:262
					return node.init ? child (node.id) + ' = ' + child (node.init) : child (node.id);
				case Syntax.BlockStatement:                                        // generator.jsxi:267
					temp = node.body.length > 0;                                   // generator.jsxi:268
					result = '{' + end () + '\t';                                  // generator.jsxi:270
					
					if (parent.type === Syntax.FunctionDeclaration || parent.type === Syntax.FunctionExpression){
						var __1b = parent.params;
						
						for (var __1a = 0; __1a < __1b.length; __1a ++){
							var param = __1b [__1a];
							
							if (param.defaultValue){                               // generator.jsxi:274
								result += 'if (' + child (param) + ' === undefined)' + end () + '\t\t' + child (param) + ' = ' + child (param.defaultValue) + ';' + end () + '\n\t' + tabs;
								temp = true;                                       // generator.jsxi:276
							}
						}
					...
					result += mapArray (node.body, '', true);                      // generator.jsxi:279
					result += end () + '}';                                        // generator.jsxi:280
					
					if (temp){                                                     // generator.jsxi:282
						return result;                                             // generator.jsxi:283
					} else
						return '{}';                                               // generator.jsxi:285
				case Syntax.ExpressionStatement:                                   // generator.jsxi:287
					result = child (node.expression);                              // generator.jsxi:288
					
					if (/^function\s*\(/.test (result))                            // generator.jsxi:289
						return '(' + result + ');';                                // generator.jsxi:290
					else
						return result + ';';                                       // generator.jsxi:292
				case Syntax.EmptyStatement:                                        // generator.jsxi:294
					return ';';                                                    // generator.jsxi:295
				case Syntax.LabeledStatement:                                      // generator.jsxi:297
					return child (node.label) + ': ' + child (node.body);          // generator.jsxi:298
				case Syntax.NotImplementedStatement:                               // generator.jsxi:300
					return 'console.warn (\'Not implemented at ' + node.lineNumber + ' line of ' + node.filename + '\');';
				case Syntax.ReturnStatement:                                       // generator.jsxi:304
					return 'return' + (node.argument ? ' ' + child (node.argument) : '') + ';';
				case Syntax.BreakStatement:                                        // generator.jsxi:307
					if (node.label)                                                // generator.jsxi:308
						return 'break ' + child (node.label) + ';';                // generator.jsxi:309
					else
						return 'break;';                                           // generator.jsxi:311
				case Syntax.ContinueStatement:                                     // generator.jsxi:313
					if (node.label)                                                // generator.jsxi:314
						return 'continue ' + child (node.label) + ';';             // generator.jsxi:315
					else
						return 'continue;';                                        // generator.jsxi:317
				case Syntax.IfStatement:                                           // generator.jsxi:320
					result = 'if (' + child (node.test) + ')' + sub (node.consequent);
					
					if (node.alternate){                                           // generator.jsxi:323
						if (node.consequent.type !== Syntax.BlockStatement)        // generator.jsxi:324
							result += end ();                                      // generator.jsxi:325
						else
							result += ' ';                                         // generator.jsxi:327
						
						result += 'else';                                          // generator.jsxi:329
						
						if (node.alternate.type === Syntax.IfStatement){           // generator.jsxi:331
							result += ' ' + child (node.alternate);                // generator.jsxi:332
						} else {
							if (node.alternate.type === Syntax.BlockStatement)     // generator.jsxi:334
								result += ' ';                                     // generator.jsxi:335
							
							result += sub (node.alternate);                        // generator.jsxi:336
						}
					}
					return result;                                                 // generator.jsxi:340
				case Syntax.SwitchStatement:                                       // generator.jsxi:342
					result = 'switch (' + child (node.discriminant) + '){';        // generator.jsxi:343
					
					{
						...
						for (var __1c = 0; __1c < __1d.length; __1c ++){
							...
							result += indent (obj);                                // generator.jsxi:345
						}
						
						__1d = undefined;
					}
					return result + end () + '}';                                  // generator.jsxi:346
				case Syntax.SwitchCase:                                            // generator.jsxi:348
					result = (node.test ? 'case ' + child (node.test) : 'default') + ':' + end ();
					return result + '\t' + mapArray (node.consequent, '', true);   // generator.jsxi:350
				case Syntax.WhileStatement:                                        // generator.jsxi:353
					return 'while (' + child (node.test) + ')' + sub (node.body);
				case Syntax.DoWhileStatement:                                      // generator.jsxi:356
					result = 'do';                                                 // generator.jsxi:357
					
					if (node.body.type !== Syntax.BlockStatement)                  // generator.jsxi:358
						result += sub (node.body) + end ();                        // generator.jsxi:359
					else
						result += ' ' + sub (node.body) + ' ';                     // generator.jsxi:361
					return result + 'while (' + child (node.test) + ');';          // generator.jsxi:362
				case Syntax.ForStatement:                                          // generator.jsxi:364
					result = 'for (';                                              // generator.jsxi:365
					
					if (node.init)                                                 // generator.jsxi:367
						result += child (node.init) + ';';                         // generator.jsxi:368
					else
						result += ';';                                             // generator.jsxi:370
					
					if (node.test)                                                 // generator.jsxi:372
						result += ' ' + child (node.test) + ';';                   // generator.jsxi:373
					else
						result += ';';                                             // generator.jsxi:375
					
					if (node.update)                                               // generator.jsxi:377
						result += ' ' + child (node.update);                       // generator.jsxi:378
					return result + ')' + sub (node.body);                         // generator.jsxi:380
				case Syntax.ForInStatement:                                        // generator.jsxi:382
					return 'for (' + child (node.left) + ' in ' + child (node.right) + ')' + sub (node.body);
				case Syntax.TryStatement:                                          // generator.jsxi:386
					result = 'try ' + sub (node.block) + ' ';                      // generator.jsxi:387
					
					{
						var __1f = node.handlers;
						
						for (var __1e = 0; __1e < __1f.length; __1e ++){
							var handler = __1f [__1e];
							
							result += child (handler) + ' ';                       // generator.jsxi:389
						}
						
						__1f = undefined;
					}
					
					if (node.finalizer)                                            // generator.jsxi:390
						result += 'finally ' + sub (node.finalizer);               // generator.jsxi:391
					return result;                                                 // generator.jsxi:392
				case Syntax.CatchClause:                                           // generator.jsxi:394
					return 'catch (' + child (node.param) + ')' + sub (node.body);
				case Syntax.ThrowStatement:                                        // generator.jsxi:397
					return 'throw ' + child (node.argument) + ';';                 // generator.jsxi:398
				case Syntax.DebuggerStatement:                                     // generator.jsxi:400
					return 'debugger;';                                            // generator.jsxi:401
				case Syntax.Program:                                               // generator.jsxi:404
					if (node.body.length === 0)                                    // generator.jsxi:405
						return '';                                                 // generator.jsxi:406
					
					result = '';                                                   // generator.jsxi:408
					temp = node.body [0].type;                                     // generator.jsxi:409
					
					{
						var __1g = node.body;
						
						for (var index = 0; index < __1g.length; index ++){        // generator.jsxi:411
							var childNode = __1g [index];
							
							if (index > 0){                                        // generator.jsxi:412
								if (temp !== childNode.type || childNode.type !== Syntax.ExpressionStatement || childNode.headerComment){
									temp = childNode.type;                         // generator.jsxi:414
									result += end () + '\n';                       // generator.jsxi:415
								} else
									result += end ();                              // generator.jsxi:417
							}
							
							result += child (childNode);                           // generator.jsxi:420
						}
						
						__1g = undefined;
					}
					return result + end ();                                        // generator.jsxi:423
				default:
					throw new Error ('Unsupported type: ' + node.type);            // generator.jsxi:426
			}
		}
		return function (arg){                                                     // generator.jsxi:430
			comments = [];                                                         // generator.jsxi:431
			
			var max = - 1,                                                         // generator.jsxi:433
				maxAllowed = 80,                                                   // generator.jsxi:434
				indent,                                                            // generator.jsxi:435
				begins = [],                                                       // generator.jsxi:436
				previous,                                                          // generator.jsxi:437
				index = 0,                                                         // generator.jsxi:438
				result = generate (arg, '');                                       // generator.jsxi:439
			
			if (niceMode){                                                         // generator.jsxi:441
				result = result.replace (/([^\n]*?)\/\/(\d+)\n/g,                  // generator.jsxi:442
					function (match, begin, found){                                // generator.jsxi:443
						var length = begin.replace (/\t/g, '    ').length;
						
						if (length > maxAllowed){                                  // generator.jsxi:446
							return begin + '\n';                                   // generator.jsxi:447
						} else {
							if (previous !== found)                                // generator.jsxi:449
								previous = found;                                  // generator.jsxi:450
							else
								found = '...';                                     // generator.jsxi:452
							
							begins.push (length);                                  // generator.jsxi:454
							
							if (length > max)                                      // generator.jsxi:455
								max = length;                                      // generator.jsxi:456
							return begin + '//' + found + '\n';                    // generator.jsxi:457
						}
					}).replace (/\/\/(\d+)\n/g,                                    // generator.jsxi:460
					function (match, comment){                                     // generator.jsxi:460
						return spaces.substr (0, max - begins [index ++]) + '   // ' + comments [+ comment] + '\n';
					});
			}
			return result;                                                         // generator.jsxi:464
		};
	}();
...
LiteParser.prototype.on = function (){                                             // lite_parser.jsxi:62
	...
	for (var __1h = 0; __1h < args.length; __1h ++){                               // lite_parser.jsxi:72
		var entry = args [__1h];
...
LiteParser.prototype.innerFindNext = function (args, fixedMode){                   // lite_parser.jsxi:121
	...
	{
		var __1i = this.binded;
		
		for (var i = 0; i < __1i.length; i ++){                                    // lite_parser.jsxi:154
			var arg = __1i [i];
	...
	try {
		{
			...
			for (var id = 0; id < __1m.length; id ++){                             // macro.jsxi:180
				var arg = __1m [id];
...
MacroCall.prototype.prepareArguments = function (callback){                        // macro_call.jsxi:44
	...
	
	{
		...
		for (var i = 0; i < __1n.length; i ++){                                    // macro_call.jsxi:73
			var arg = __1n [i];
...
MacroStorage.prototype.add = function (macro){                                     // macro_storage.jsxi:10
	...
	{
		var __1r = this.requests;
		
		for (var pos = 0; pos < __1r.length; pos ++){                              // macro_storage.jsxi:18
			var request = __1r [pos];
...
Worker.prototype.start = function (callback){                                      // worker.jsxi:36
	...
	{
		var __1v = File.find ('default/*') || [];
		
		for (var __1u = 0; __1u < __1v.length; __1u ++){
			var file = __1v [__1u];
